...
package com.connectm.iot.pubsubmessaging;
...
public class CmSubscriber {
  ...
  private static void setGoogleTruthEnv() {
	  ProcessBuilder pb = new ProcessBuilder();
	  pb.environment().put("GOOGLE_APPLICATION_CREDENTIALS", "./CityLegends-3757653fb6d8.json");
  }
}
